...
![rts](/aws-fcj/images/2.cloudserver/rt-01.png)
...
![rts](/aws-fcj/images/3.dataserver/rts-01.png)

3. After creating the route table successfully.
  + Click **Edit routes**.

![rts](/aws-fcj/images/3.dataserver/rts-02.png)
...
![rts](/aws-fcj/images/3.dataserver/rts-03.png)
...
![rts](/aws-fcj/images/3.dataserver/rts-04.png)

6. At the **Edit subnet associations** page.
  + Click on **Data-Subnet-Public**.
  + Click **Save associations**.

![rts](/aws-fcj/images/3.dataserver/rts-05.png)
