...
![Page Chapitre](/en/cont/pages{{ .Site.BaseURL }}images/pages-chapter.png?width=50pc)
...
![Page défaut](/en/cont/pages{{ .Site.BaseURL }}images/pages-default.png?width=50pc)
...
![Titre avec icône](/en/cont/pages{{ .Site.BaseURL }}images/frontmatter-icon.png)
