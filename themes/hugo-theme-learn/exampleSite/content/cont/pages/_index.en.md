...
![Chapter page](/en/cont/pages{{ .Site.BaseURL }}images/pages-chapter.png?width=50pc)
...
![Default page](/en/cont/pages{{ .Site.BaseURL }}images/pages-default.png?width=50pc)
...
![Title with icon](/en/cont/pages{{ .Site.BaseURL }}images/frontmatter-icon.png)
